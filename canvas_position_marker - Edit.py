        ...
        if not self.deleted:
            if 0 - 50 < canvas_pos_x < self.map_widget.width + 50 and 0 < canvas_pos_y < self.map_widget.height + 70:
                if self.polygon is None:
                    ...
                    if self.command2 is not None:
                        self.map_widget.canvas.tag_bind(self.polygon, "<Double-Button-1>", self.double_click)
                else:
                ...
                if self.big_circle is None:
                    ...
                    if self.command2 is not None:
                        self.map_widget.canvas.tag_bind(self.big_circle, "<Double-Button-1>", self.double_click)
                else:
                ...
                if self.text is not None:
                    if self.canvas_text is None:
                        ...
                        if self.command2 is not None:
                            self.map_widget.canvas.tag_bind(self.canvas_text, "<Double-Button-1>", self.double_click)
                    else:
